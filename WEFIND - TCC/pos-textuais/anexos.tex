...
\vspace{0.5cm}
\noindent
\textbf{3. CÓDIGO PENAL BRASILEIRO (DECRETO-LEI Nº 2.848, DE 7 DE DEZEMBRO DE 1940)}
\vspace{0.2cm}

\begin{quote}
\small
\textbf{Apropriação de coisa havida por erro, caso fortuito ou força da natureza}

\textbf{Art. 169.} Apropriar-se alguém de coisa alheia vinda ao seu poder por erro, caso fortuito ou força da natureza:
\par
Pena - detenção, de um mês a um ano, ou multa.
\par
\textit{Parágrafo único.} Na mesma pena incorre:
\par
\textbf{Apropriação de coisa achada}
\par
\textbf{II -} quem acha coisa alheia perdida e dela se apropria, total ou parcialmente, deixando de restituí-la ao dono ou legítimo possuidor ou de entregá-la à autoridade competente, dentro no prazo de quinze dias.
\end{quote}

\vspace{0.5cm}
\noindent
\textbf{4. SISTEMA NACIONAL DE CADASTRO DE ANIMAIS DOMÉSTICOS (SINPATINHAS)}
\vspace{0.2cm}

\begin{quote}
\small
Instituído no âmbito do Ministério do Meio Ambiente e Mudança do Clima (MMA) para integrar a gestão populacional de cães e gatos em território nacional, servindo de diretriz pública para a identificação individual e fomento à guarda responsável e aos programas municipais de resgate e acolhimento.
\end{quote}
