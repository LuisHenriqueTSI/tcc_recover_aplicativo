...
4b. Encerramento com sucesso: o autor altera o status para ``Reencontrado'' ou ``Adotado'', arquivando a ocorrência.
} \\ \hline
\multicolumn{2}{|l|}{\textbf{Fluxos de Exceção:}} \\
\multicolumn{2}{|>{\raggedright\arraybackslash}p{15.4cm}|}{
...
\textbf{Pós-Condições} & Ocorrência persistida, visível no mapa e disponível para a comunidade. \\ \hline
\end{tabular}
\end{table}
...
\multicolumn{2}{|l|}{\textbf{Fluxos Alternativos:}} \\
\multicolumn{2}{|>{\raggedright\arraybackslash}p{15.4cm}|}{
6a. Acionamento de alerta de fuga: caso o animal cadastrado desapareça, o tutor aciona o botão de emergência no Perfil Digital, transformando a ficha preventiva diretamente em uma publicação de busca no mapa sem necessidade de redigitação.
} \\ \hline
\multicolumn{2}{|l|}{\textbf{Fluxos de Exceção:}} \\
\multicolumn{2}{|>{\raggedright\arraybackslash}p{15.4cm}|}{
