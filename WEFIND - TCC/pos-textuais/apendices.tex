...
% ============================================================
\section*{APÊNDICE C: INSTRUMENTOS DE PESQUISA (QUESTIONÁRIO DE CAMPO E ESCALA SUS)}
\addcontentsline{toc}{section}{APÊNDICE C: INSTRUMENTOS DE PESQUISA (QUESTIONÁRIO DE CAMPO E ESCALA SUS)}
...
\vspace{0.4cm}
\subsection*{C.1 Questionário de Levantamento de Campo com Tutores (Google Forms)}
...
\subsection*{C.2 Questionário de Avaliação de Usabilidade (Escala SUS)}
...
% ============================================================
% APÊNDICE D: GUIA DE UTILIZAÇÃO (MANUAL DO USUÁRIO)
% ============================================================
\section*{APÊNDICE D: GUIA DE UTILIZAÇÃO DO SISTEMA WeFIND (MANUAL DO USUÁRIO)}
\addcontentsline{toc}{section}{APÊNDICE D: GUIA DE UTILIZAÇÃO DO SISTEMA WeFIND (MANUAL DO USUÁRIO)}
...
\noindent
Ao abrir o aplicativo, o usuário visualiza a tela de login. Caso ainda não possua cadastro, basta tocar em \textbf{``Cadastre-se''} para registrar seu perfil com nome, e-mail e telefone WhatsApp. A Figura D1 apresenta as telas de acesso e cadastro.

\vspace{0.2cm}
\noindent\begin{minipage}{\linewidth}
\centering
    \textbf{Figura D1: Telas de Login e Cadastro de Usuário}\\[0.2cm]
...
\noindent
Após o acesso, o usuário explora as ocorrências no feed ordenado por proximidade e no mapa georreferenciado por GPS, podendo filtrar os animais por espécie, porte ou raio de distância. A Figura D2 ilustra as telas de exploração.

\vspace{0.2cm}
\noindent\begin{minipage}{\linewidth}
\centering
    \textbf{Figura D2: Telas de Feed Geral e Mapa Interativo de Ocorrências}\\[0.2cm]
...
\noindent
Para registrar um animal, o usuário aciona o botão central \textbf{``+''}, escolhe a finalidade do anúncio, insere as fotos com recorte proporcional, preenche as características físicas e marca a localização no mapa. A Figura D3 apresenta a tela de cadastro.

\vspace{0.2cm}
\noindent\begin{minipage}{\linewidth}
\centering
    \textbf{Figura D3: Tela de Cadastro de Ocorrência de Animal}\\[0.2cm]
...
\noindent
Para alinhar o resgate de um animal avistado sem expor números pessoais a fraudes, o aplicativo disponibiliza o chat privativo interno com troca de fotos e mensagens em tempo real. A Figura D5 ilustra a tela de conversa.

\vspace{0.2cm}
\noindent\begin{minipage}{\linewidth}
\centering
    \textbf{Figura D5: Tela de Chat Privativo em Tempo Real}\\[0.2cm]
...
\noindent
Como medida de identificação preventiva, o tutor acessa a área de seus pets no perfil para cadastrar previamente seu animal, incluindo vacinas, fotos e histórico médico. O sistema gera o Perfil Digital do Pet com código QR para identificação rápida. A Figura D6 ilustra a tela do Perfil Digital do Pet.

\vspace{0.2cm}
\noindent\begin{minipage}{\linewidth}
\centering
    \textbf{Figura D6: Tela do Perfil Digital do Pet}\\[0.2cm]
