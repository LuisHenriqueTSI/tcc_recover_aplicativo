...
\textbf{Ator Principal} & Usuário (Autenticado) \\ \hline
\textbf{Atores Secundários} & Banco de Dados (PostgreSQL) e Supabase Storage \\ \hline
\textbf{Resumo} & Permite cadastrar previamente os dados dos animais domésticos tutelados, gerando o Perfil Digital do Pet com código QR de autenticidade. \\ \hline
...
5. O sistema grava os registros e gera o Perfil Digital do Pet com código QR e identificador único.\par
6. O perfil do animal fica disponível para consulta, edição ou compartilhamento.
} \\ \hline
\multicolumn{2}{|l|}{\textbf{Fluxos Alternativos e de Exceção:}} \\
\multicolumn{2}{|>{\raggedright\arraybackslash}p{15.4cm}|}{
6a. O animal fugiu: o tutor aciona o botão de emergência no perfil do pet, convertendo os dados cadastrados diretamente em uma publicação de animal perdido no mapa sem precisar redigitar nada.
} \\ \hline
\textbf{Pós-Condições} & Perfil Digital do Pet ativo e vinculado à conta do tutor. \\ \hline
\end{tabular}
\end{table}
...
% ============================================================
% APÊNDICE D: INSTRUMENTOS DE PESQUISA
% ============================================================
\section*{APÊNDICE D: INSTRUMENTOS DE PESQUISA (QUESTIONÁRIO DE CAMPO E ESCALA SUS)}
\addcontentsline{toc}{section}{APÊNDICE D: INSTRUMENTOS DE PESQUISA (QUESTIONÁRIO DE CAMPO E ESCALA SUS)}

Este apêndice documenta os instrumentos de coleta de dados primários aplicados durante a pesquisa empírica inicial com tutores (Google Forms) e durante os testes práticos de validação da aplicação (Escala SUS).

\vspace{0.4cm}
\subsection*{D.1 Questionário de Levantamento de Campo com Tutores (Google Forms)}

Instrumento aplicado aos 20 participantes voluntários (tutores de animais de estimação e pessoas engajadas na causa animal) na etapa de diagnóstico de viabilidade e elicitação de requisitos (Capítulo 3).
...
\centering
\small
\begin{tabular}{|c|>{\raggedright\arraybackslash}p{6.5cm}|>{\raggedright\arraybackslash}p{7.2cm}|}
\hline
\textbf{Item} & \textbf{Pergunta Formulada} & \textbf{Opções de Resposta / Formato} \\ \hline
Q01 & Você é tutor de algum animal de estimação (cão ou gato)? & [ ] Sim, cão(s) \newline [ ] Sim, gato(s) \newline [ ] Sim, ambos \newline [ ] Não possuo \\ \hline
Q02 & Algum animal seu já fugiu ou você já ajudou a resgatar um animal perdido? & [ ] Sim, meu pet já desapareceu \newline [ ] Já ajudei no resgate de pet alheio \newline [ ] Ambas as situações \newline [ ] Nenhuma das opções \\ \hline
Q03 & Quais canais você mais costuma utilizar para divulgar um pet perdido? & [ ] Redes sociais (Instagram/Facebook) \newline [ ] Grupos de WhatsApp \newline [ ] Cartazes impressos em postes \newline [ ] Contato pessoal com vizinhos \newline [ ] Clínicas veterinárias locais \\ \hline
Q04 & Quais as maiores dificuldades encontradas na divulgação tradicional? & Resposta aberta (relatos sobre falta de mapa, demora, perda de alcance em feeds e exposição de telefone particular a trotes) \\ \hline
Q05 & Você utilizaria um aplicativo com mapa interativo via GPS para localizar pets perdidos por proximidade? & Escala linear de 1 (Pouco Útil) a 5 (Extremamente Útil) \\ \hline
Q06 & Considera importante a geração automática de cartazes com QR Code para impressão e compartilhamento? & [ ] Sim, essencial \newline [ ] Sim, útil \newline [ ] Indiferente \newline [ ] Pouco útil \\ \hline
Q07 & Você utilizaria um perfil digital preventivo do animal para guardar vacinas e identificação rápida do pet? & [ ] Com certeza \newline [ ] Provavelmente sim \newline [ ] Talvez \newline [ ] Não utilizaria \\ \hline
\end{tabular}
\end{table}

\clearpage

\subsection*{D.2 Questionário de Avaliação de Usabilidade (Escala SUS)}

Instrumento padronizado de avaliação de usabilidade aplicado aos 20 voluntários participantes dos testes práticos da aplicação desenvolvida (Capítulo 6), elaborado segundo a metodologia padronizada \textit{System Usability Scale} (LEWIS, 2021; SAURO; LEWIS, 2022). 
...
\subsection*{Passo 6: Cadastro e Visualização do Perfil Digital do Pet}
\noindent
Como medida de identificação preventiva, o tutor acessa a área de seus pets no perfil para cadastrar previamente seu animal, incluindo vacinas, fotos e histórico médico. O sistema gera o Perfil Digital do Pet com código QR para identificação rápida. A Figura E6 ilustra a tela do Perfil Digital do Pet.

\vspace{0.2cm}
\noindent\begin{minipage}{\linewidth}
\centering
    \textbf{Figura E6: Tela do Perfil Digital do Pet}\\[0.2cm]
