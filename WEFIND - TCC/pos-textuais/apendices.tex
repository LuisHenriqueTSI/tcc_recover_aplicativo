...
Instrumento aplicado aos 20 participantes voluntários (tutores de animais de estimação e pessoas engajadas na causa animal) na etapa de diagnóstico de viabilidade e elicitação de requisitos (Capítulo 3). O questionário online original formulado na plataforma Google Forms, contendo todas as perguntas e opções de resposta, pode ser acessado na íntegra através do seguinte endereço eletrônico:

\vspace{0.15cm}
\noindent
\url{https://docs.google.com/forms/d/e/1FAIpQLSeMPnr8sNBEXa9FWTlX4BbVssyIAwzkl1NhmUxQiC9IyS9eQ/viewform?pli=1&pli=1}
