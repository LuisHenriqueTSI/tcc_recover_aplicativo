...
\centering
    ...
    \hspace{0.5cm}
    \includegraphics[height=7.8cm, keepaspectratio]{imagens/05_manual_usuario/figura31_tela_cadastro.jpeg}\\[0.15cm]
...
\centering
    ...
    \hspace{0.5cm}
    \includegraphics[height=8.0cm, keepaspectratio]{imagens/05_manual_usuario/tela-mapa.jpeg}\\[0.15cm]
    \begin{tabular}{p{4.5cm} p{4.5cm}}
        \centering\footnotesize (a) Feed Geral & \centering\footnotesize (b) Mapa Interativo
    \end{tabular}\\[0.15cm]
    {\footnotesize Fonte: Autoria própria (2026)}
\end{minipage}
...
\centering
    ...
    \hspace{0.5cm}
    \includegraphics[height=7.8cm, keepaspectratio]{imagens/05_manual_usuario/tela-compartilhar-animal-perdido.jpeg}\\[0.15cm]
    \begin{tabular}{p{4.5cm} p{4.5cm}}
        \centering\footnotesize (a) Detalhes do Animal & \centering\footnotesize (b) Modal de Compartilhamento
    \end{tabular}\\[0.15cm]
    {\footnotesize Fonte: Autoria própria (2026)}
\end{minipage}
