...
Q04 & Quais canais você mais costuma utilizar para divulgar um pet perdido? & [ ] Redes sociais (Instagram/Facebook) \newline [ ] Grupos de WhatsApp \newline [ ] Cartazes impressos em postes \newline [ ] Contato pessoal com vizinhos \newline [ ] Clínicas veterinárias locais \\ \hline
Q05 & Quais as maiores dificuldades encontradas na divulgação tradicional? & Resposta aberta (relatos sobre falta de mapa, demora, perda de alcance em feeds e exposição de telefone particular a trotes) \\ \hline
Q06 & Você utilizaria um aplicativo com mapa interativo via GPS para localizar pets perdidos por proximidade? & Escala linear de 1 (Pouco Útil) a 5 (Extremamente Útil) \\ \hline
Q07 & Considera importante a geração automática de cartazes com QR Code para impressão e compartilhamento? & [ ] Sim, essencial \newline [ ] Sim, útil \newline [ ] Indiferente \newline [ ] Pouco útil \\ \hline
Q08 & Você utilizaria um perfil digital preventivo do animal para guardar vacinas e identificação rápida do pet? & [ ] Com certeza \newline [ ] Provavelmente sim \newline [ ] Talvez \newline [ ] Não utilizaria \\ \hline
\end{tabular}
\end{table}
