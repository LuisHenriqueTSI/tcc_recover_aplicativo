...
Esta seção documenta os resultados consolidados e o instrumento de coleta de dados primários aplicado aos 20 participantes voluntários na plataforma Google Forms durante a etapa de diagnóstico empírico e levantamento de requisitos (Capítulo~3). As Figuras~B1 a B6 apresentam as distribuições percentuais de respostas obtidas nas questões centrais da pesquisa.
...
As Figuras~B7 a B9 reproduzem as telas estruturadas do instrumento de pesquisa aplicado:
