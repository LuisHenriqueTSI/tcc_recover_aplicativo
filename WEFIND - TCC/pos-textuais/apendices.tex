...
\subsection*{B.1 Levantamento de Campo com Tutores (Gráficos e Instrumento de Pesquisa)}

Esta seção documenta os resultados e o instrumento de coleta de dados primários aplicado aos 20 participantes voluntários na plataforma Google Forms durante a etapa de diagnóstico empírico e levantamento de requisitos (Capítulo~3).

A Figura~B1 apresenta a distribuição das respostas relativas à relação dos participantes com os animais de estimação e as espécies que tutelam.
...
As Figuras~B2 a B6 apresentam a reprodução visual das telas e questões estruturadas do questionário aplicado:

\begin{figure}[H]
    \centering
    \caption{Questionário no Google Forms: Identificação e Perfil dos Participantes}
    \label{fig:forms_parte1}
    \includegraphics[width=0.72\textwidth,height=13.5cm,keepaspectratio]{imagens/01_pesquisa/questionario_forms_parte1.png}
    \fonte{Dados da pesquisa (Google Forms, 2026)}
\end{figure}
\clearpage
...
\begin{figure}[H]
    \centering
    \caption{Questionário no Google Forms: Canais de Divulgação, Dificuldades e Mapa Interativo}
    \label{fig:forms_parte2}
    \includegraphics[width=0.72\textwidth]{imagens/01_pesquisa/questionario_forms_parte2.png}
    \fonte{Dados da pesquisa (Google Forms, 2026)}
\end{figure}
\clearpage
...
\begin{figure}[H]
    \centering
    \caption{Questionário no Google Forms: Recursos de Resgate, Chat Privativo e Segurança}
    \label{fig:forms_parte3}
    \includegraphics[width=0.72\textwidth]{imagens/01_pesquisa/questionario_forms_parte3.png}
    \fonte{Dados da pesquisa (Google Forms, 2026)}
\end{figure}
\clearpage
...
\begin{figure}[H]
    \centering
    \caption{Questionário no Google Forms: Recompensa, Filtros de Busca e Tempo de Publicação}
    \label{fig:forms_parte4}
    \includegraphics[width=0.72\textwidth]{imagens/01_pesquisa/questionario_forms_parte4.png}
    \fonte{Dados da pesquisa (Google Forms, 2026)}
\end{figure}
\clearpage
...
\begin{figure}[H]
    \centering
    \caption{Questionário no Google Forms: Diferenciais do WeFIND e Finalização}
    \label{fig:forms_parte5}
    \includegraphics[width=0.72\textwidth]{imagens/01_pesquisa/questionario_forms_parte5.png}
    \fonte{Dados da pesquisa (Google Forms, 2026)}
\end{figure}
\clearpage
