...
\noindent
Ao avistar ou resgatar um animal desorientado em vias públicas, o cidadão inicia o fluxo de cadastro comunitário acionando o botão central ``+'' na barra inferior de navegação. O assistente orienta o preenchimento por etapas sequenciais, associando dados morfológicos, mídias fotográficas e coordenadas geográficas exatas. A Figura~C3 ilustra a etapa de caracterização do animal e o georreferenciamento no mapa interativo.
...
\begin{figure}[H]
    ...
    \begin{minipage}[t]{0.48\textwidth}
        ...
        \par\vspace{0.12cm}
        {\small Figura C3.a) Morfologia e Fotos}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.48\textwidth}
        \centering
...
Conforme ilustrado na Figura~C5, o sistema de mensageria promove o alinhamento seguro entre as partes envolvidas no resgate. Na Figura~C5.a, a central de mensagens reúne as conversas ativas organizadas por animal, exibindo a fotografia do interlocutor, o status do anúncio, o carimbo de data e hora e o indicador de mensagens não lidas. Ao acessar uma conversa específica, a tela exibida na Figura~C5.b exibe o bate-papo criptografado e bidirecional com entrega imediata, no qual os membros podem trocar orientações de ponto de encontro e anexar fotografias comprobatórias de marcas singulares, eliminando por completo a necessidade de expor telefones particulares em murais públicos.
...
A estrutura preventiva sintetizada na Figura~C6 consolida uma barreira de segurança de baixo custo contra o desaparecimento definitivo de animais. Na Figura~C6.a, o painel de gestão preventiva lista os pets sob responsabilidade do usuário, exibindo foto, raça, idade e a ação de emergência ``Alerta de Fuga'', que converte instantaneamente o prontuário em anúncio de busca ativo no mapa e feed com um único toque. Ao selecionar o animal, a tela exibida na Figura~C6.b exibe a carteirinha digital de identificação (RG Pet), contendo dados biométricos, contato de emergência e código QR exclusivo para impressão ou acoplamento a plaquinhas de coleira, permitindo que qualquer pessoa que encontre o animal na rua acesse a ficha pública segura escaneando a câmera do celular.
