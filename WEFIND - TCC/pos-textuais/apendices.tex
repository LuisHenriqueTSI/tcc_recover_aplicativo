...
\textbf{Nome do Caso de Uso} & Manter Animais Tutelados \\ \hline
\textbf{Ator Principal} & Usuário (Autenticado) \\ \hline
\textbf{Atores Secundários} & Banco de Dados (PostgreSQL) e Supabase Storage \\ \hline
...
\subsection*{Passo 6: Cadastro e Identificação de Animais Tutelados}
\noindent
...
\noindent\begin{minipage}{\linewidth}
\centering
    \textbf{Figura C6: Tela de Identificação do Animal Tutelado}\\[0.2cm]
