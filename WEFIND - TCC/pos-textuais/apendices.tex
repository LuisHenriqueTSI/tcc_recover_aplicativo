...
\vspace{0.4cm}
\subsection*{B.1 Questionário de Levantamento de Campo com Tutores (Google Forms)}

Instrumento aplicado aos 20 participantes voluntários (tutores de animais de estimação e pessoas engajadas na causa animal) na etapa de diagnóstico de viabilidade e elicitação de requisitos (Capítulo 3). O questionário online original formulado na plataforma Google Forms pode ser acessado na íntegra através do seguinte endereço eletrônico: \url{https://docs.google.com/forms/d/e/1FAIpQLSeMPnr8sNBEXa9FWTlX4BbVssyIAwzkl1NhmUxQiC9IyS9eQ/viewform?pli=1&pli=1}.
...
Q03 & Seu(s) animal(is) utiliza(m) microchip de identificação? & [ ] Sim \newline [ ] Não \newline [ ] Não sei \\ \hline
Q04 & Seu(s) animal(is) utilizam algum tipo de coleira de identificação? & [ ] Não utiliza nenhum tipo \newline [ ] Sim, com plaquinha de identificação \newline [ ] Sim, com GPS/rastreamento \\ \hline
Q05 & Quais canais você mais costuma utilizar para divulgar um pet perdido? & [ ] Redes sociais (Instagram/Facebook) \newline [ ] Grupos de WhatsApp \newline [ ] Cartazes impressos em postes \newline [ ] Contato pessoal com vizinhos \newline [ ] Clínicas veterinárias locais \\ \hline
Q06 & Quais as maiores dificuldades encontradas na divulgação tradicional? & Resposta aberta (relatos sobre falta de mapa, demora, perda de alcance em feeds e exposição de telefone particular a trotes) \\ \hline
Q07 & Você utilizaria um aplicativo com mapa interativo via GPS para localizar pets perdidos por proximidade? & Escala linear de 1 (Pouco Útil) a 5 (Extremamente Útil) \\ \hline
Q08 & Considera importante a geração automática de cartazes com QR Code para impressão e compartilhamento? & [ ] Sim, essencial \newline [ ] Sim, útil \newline [ ] Indiferente \newline [ ] Pouco útil \\ \hline
Q09 & Você utilizaria um perfil digital preventivo do animal para guardar vacinas e identificação rápida do pet? & [ ] Com certeza \newline [ ] Provavelmente sim \newline [ ] Talvez \newline [ ] Não utilizaria \\ \hline
\end{tabular}
\end{table}
...
\noindent\begin{minipage}{\linewidth}
\centering
    \textbf{Figura C2: Telas de Feed Geral e Mapa Interativo de Ocorrências}\\[0.2cm]
...
\noindent
Para registrar um animal, o usuário aciona o botão central \textbf{``+''}, escolhe a finalidade do anúncio, insere as fotos com recorte proporcional, preenche as características físicas e marca a localização no mapa. A Figura C3 apresenta a tela de cadastro.

\vspace{0.2cm}
\noindent\begin{minipage}{\linewidth}
\centering
    \textbf{Figura C3: Tela de Cadastro de Ocorrência de Animal}\\[0.2cm]
...
\noindent\begin{minipage}{\linewidth}
\centering
    \textbf{Figura C4: Tela de Detalhes do Animal e Modal de Compartilhamento de Cartaz}\\[0.2cm]
...
\noindent\begin{minipage}{\linewidth}
\centering
    \textbf{Figura C5: Tela de Chat Privativo em Tempo Real}\\[0.2cm]
...
\noindent
Como medida de identificação preventiva, o tutor acessa a área de seus pets no perfil para cadastrar previamente seu animal, incluindo vacinas, fotos e histórico médico. O sistema gera o Perfil Digital do Pet com código QR para identificação rápida. A Figura C6 ilustra a tela do Perfil Digital do Pet.

\vspace{0.2cm}
\noindent\begin{minipage}{\linewidth}
\centering
    \textbf{Figura C6: Tela do Perfil Digital do Pet}\\[0.2cm]
