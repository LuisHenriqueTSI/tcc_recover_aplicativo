...
\vspace{0.3cm}
\noindent
\textbf{Instruções ao participante:} Este questionário tem como finalidade diagnosticar os hábitos de identificação animal e as principais dificuldades enfrentadas durante o desaparecimento e resgate de cães e gatos. Por favor, responda a cada uma das questões a seguir:

\vspace{0.4cm}
\noindent
\textbf{Questão 1: Você é tutor de algum animal de estimação (cão ou gato)?}\par
[ ] Sim, cão(s)\par
[ ] Sim, gato(s)\par
[ ] Sim, ambos\par
[ ] Não possuo
...
\vspace{0.3cm}
\noindent
\textbf{Questão 2: Algum animal seu já fugiu ou você já ajudou a resgatar um animal perdido?}\par
[ ] Sim, meu animal de estimação já desapareceu\par
[ ] Já ajudei no resgate de animal de terceiro\par
[ ] Ambas as situações anteriores\par
[ ] Nenhuma das opções

\vspace{0.3cm}
\noindent
\textbf{Questão 3: Seu(s) animal(is) utiliza(m) microchip de identificação eletrônica?}\par
[ ] Sim\par
[ ] Não\par
[ ] Não sei informar
...
\vspace{0.3cm}
\noindent
\textbf{Questão 4: Seu(s) animal(is) utiliza(m) algum tipo de coleira de identificação?}\par
[ ] Não utiliza nenhum tipo de coleira\par
[ ] Sim, com plaquinha de identificação visual\par
[ ] Sim, equipada com dispositivo GPS ou rastreamento

\vspace{0.3cm}
\noindent
\textbf{Questão 5: Quais canais você mais costuma utilizar para divulgar um animal perdido?}\par
...
\vspace{0.3cm}
\noindent
\textbf{Questão 6: Quais as maiores dificuldades encontradas na divulgação tradicional?}\par
\textit{Campo discursivo aberto para relatos dos tutores sobre demora, perda de alcance em feeds, falta de mapas e medo de golpes ao divulgar telefone.}

\vspace{0.3cm}
\noindent
\textbf{Questão 7: Em uma escala de 1 a 5, qual o nível de utilidade de visualizar animais perdidos em um mapa interativo com filtro de proximidade?}\par
[ ] 1 (Sem utilidade)\par
...
\vspace{0.3cm}
\noindent
\textbf{Questão 8: Você utilizaria um aplicativo comunitário gratuito dedicado exclusivamente ao resgate e divulgação de animais?}\par
[ ] Sim, certamente\par
...
\vspace{0.3cm}
\noindent
\textbf{Questão 9: Quais recursos você consideraria mais importantes em um aplicativo como o WeFIND?}\par
[ ] Geração automática de cartazes de busca com código QR\par
[ ] Bate-papo privativo em tempo real para contato seguro\par
[ ] Cadastro preventivo com Perfil Digital do Pet\par
[ ] Filtros avançados por espécie, cor e porte do animal\par
...
Instrumento padronizado de avaliação de usabilidade aplicado aos 20 voluntários participantes dos testes práticos da aplicação desenvolvida (Capítulo 7), elaborado segundo a metodologia padronizada \textit{System Usability Scale} (LEWIS, 2021; SAURO; LEWIS, 2022). 
