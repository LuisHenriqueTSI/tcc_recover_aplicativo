...
Instrumento estruturado de coleta de dados primários elaborado e disponibilizado aos participantes voluntários na plataforma Google Forms durante a etapa de diagnóstico empírico e levantamento de requisitos (Capítulo~3). As Figuras~B1 a B5 apresentam a reprodução visual completa das telas e questões que compõem o formulário aplicado.
