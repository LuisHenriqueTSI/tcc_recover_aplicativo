...
\textbf{CT02} & RF03 & Recuperação de Senha via WhatsApp & Solicitação de código de redefinição para o telefone cadastrado & Envio do código OTP de 6 dígitos via WhatsApp e atualização segura da nova senha & \statusTeste \\ \hline
