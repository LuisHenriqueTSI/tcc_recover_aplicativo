...
Este capítulo detalha as bibliotecas que compõem o ecossistema de desenvolvimento móvel do WeFIND com suas respectivas versões, descreve a infraestrutura de computação em nuvem provida pelo Supabase, apresenta a modelagem lógica relacional do banco de dados PostgreSQL estruturada com políticas de segurança em nível de linha (RLS) e relaciona as ferramentas auxiliares utilizadas na gestão e governança do projeto, culminando em um quadro consolidado de versões de software empregadas.
