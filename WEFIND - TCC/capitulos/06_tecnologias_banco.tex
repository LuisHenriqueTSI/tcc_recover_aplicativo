...
Para reduzir o envio de alertas pouco relevantes, o algoritmo executa primeiramente uma checagem de viabilidade biológica e física. Três critérios possuem poder de veto absoluto (\textit{deal breakers}); caso qualquer um deles seja violado, o sistema atribui escore nulo (0 pontos) imediatamente, encerrando o cálculo sem necessidade de avaliações adicionais.
...
Persistência Local & async-storage & 2.2.0 & Persistência local de dados de sessão e preferências; o mecanismo não é tratado, por si só, como armazenamento criptografado. \\ \hline
