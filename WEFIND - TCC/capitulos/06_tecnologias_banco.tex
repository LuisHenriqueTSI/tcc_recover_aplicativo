...
Para impedir o inchaço do banco de dados e evitar o acúmulo de arquivos em nuvem, o sistema adota uma rotina periódica de limpeza definitiva. Caso a publicação permaneça inativa após um período de carência (30 a 60 dias), ela é apagada em definitivo da base PostgreSQL. Essa exclusão ocorre em cascata (\textit{CASCADE}), removendo os registros vinculados na tabela \textit{fotos\_animais} e apagando as imagens hospedadas no Supabase Storage, assegurando alta performance e sustentabilidade da infraestrutura.
