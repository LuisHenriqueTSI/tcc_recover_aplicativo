...
O desenvolvimento deste Trabalho de Conclusão de Curso teve como resultado a concepção, modelagem, implementação e validação da plataforma WeFIND, desenvolvida como um aplicativo móvel colaborativo voltado ao resgate, proteção e guarda responsável de animais domésticos. A proposta consolidou-se como uma resposta tecnológica estruturada aos desafios enfrentados pelas famílias tutoras nos centros urbanos, integrando a comunidade em uma rede solidária capaz de acelerar a localização de pets e promover reencontros de maneira ágil, segura e coordenada.

A avaliação do ciclo global de engenharia de software confirma o pleno atingimento dos objetivos traçados para a pesquisa. O diagnóstico empírico de campo e a análise comparativa de soluções similares forneceram os subsídios necessários para a elicitação rigorosa dos 46 requisitos funcionais e 14 requisitos não funcionais, bem como a formalização dos modelos conceituais em notação UML. Todas as funcionalidades planejadas foram integralmente implementadas na camada cliente móvel e nos serviços em nuvem, alcançando alta coesão arquitetural e estrita conformidade com as regras de negócio estabelecidas.

\ifversaoorientadora
O design centrado no usuário viabilizou uma experiência inclusiva, intuitiva e ergonômica, consolidada na escala tipográfica sem serifa Roboto e em uma paleta cromática semântica que orienta a tomada de decisão rápida. O planejamento metodológico de testes funcionais e de usabilidade (protocolo SUS) estabelece a matriz de conformidade técnica e usabilidade da aplicação frente aos 46 requisitos levantados, visando assegurar que o WeFIND entregue uma ferramenta acolhedora, estável e de alta eficácia comunitária.
\else
