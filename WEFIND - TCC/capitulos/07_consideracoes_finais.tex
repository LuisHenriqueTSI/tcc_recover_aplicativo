...
\begin{itemize}
    ...
    \item \textbf{Integração com coleiras com chip ou QR Code físico:} permitir que o QR Code gerado pelo Perfil Digital do Pet seja impresso em plaquinhas metálicas para coleiras;
