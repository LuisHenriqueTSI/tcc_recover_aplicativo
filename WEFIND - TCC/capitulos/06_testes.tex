...
\begin{tabular}{|c|>{\raggedright\arraybackslash}p{3.3cm}|>{\raggedright\arraybackslash}p{4.0cm}|>{\raggedright\arraybackslash}p{3.8cm}|c|}
\hline
...
Para avaliar a experiência de uso de forma padronizada, foi aplicado o questionário \textit{System Usability Scale} (SUS), método psicométrico amplamente consolidado e validado na literatura contemporânea de avaliação da experiência do usuário (LEWIS, 2021; SAURO; LEWIS, 2022). 
