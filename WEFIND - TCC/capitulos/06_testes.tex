...
A média final das respostas dos 20 voluntários ao questionário SUS resultou em uma pontuação de \textbf{85,3 pontos}. De acordo com as faixas de classificação avaliadas por Lewis (2021) e Sauro e Lewis (2022), notas acima de 80 pontos colocam o sistema no nível de usabilidade \textbf{Excelente} (\textit{Grade A}), confirmando que o WeFIND apresenta interface limpa, navegação intuitiva e é muito fácil de usar.
