...
O questionário SUS conta com 10 afirmações respondidas em escala de 1 (discordo totalmente) a 5 (concordo totalmente), alternando perguntas positivas e negativas para evitar respostas automáticas (Apêndice C, Seção C.2). A pontuação final varia de 0 a 100 pontos, calculada pela fórmula:
\begin{equation}
