...
Por fim, com o propósito de incentivar o cuidado preventivo antes de qualquer imprevisto, o aplicativo conta com o módulo exclusivo de gestão de animais da família e visualização do \textbf{Perfil Digital do Pet}. Nesse espaço, o tutor cadastra previamente os animais sob sua tutela, registrando histórico de vacinação, características individuais, foto oficial e gerando uma página digital provida de código QR próprio de identificação. A Figura~\ref{fig:tela_perfil_pet} exibe a interface do Perfil Digital do Pet.
