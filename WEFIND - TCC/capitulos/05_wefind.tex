...
\subsection{Processos de Software e Metodologia de Desenvolvimento}

Para organizar o trabalho de desenvolvimento do WeFIND, utilizou-se o modelo de ciclo de vida incremental e iterativo (PRESSMAN; MAXIM, 2021; SOMMERVILLE, 2018). Essa abordagem permitiu construir o aplicativo em partes funcionais e utilizáveis, começando pela tela de login e cadastro de usuários, passando pelo feed e mapa interativo, cadastro e edição de publicações, chat em tempo real, gerador de cartazes e a carteirinha digital (RG Pet). Dessa forma, cada função pôde ser testada e melhorada antes de passar para o próximo passo.

O controle das tarefas do dia a dia foi feito com base no método visual Kanban por meio da ferramenta Trello, organizando o fluxo de trabalho em colunas como tarefas a fazer, em andamento, em testes e concluídas. Todo o código-fonte foi versionado com o Git, mantendo o histórico de alterações e o código seguro no GitHub.
...
Para a concepção do ícone e símbolo visual da marca, utilizou-se a ferramenta de inteligência artificial generativa Flow Labs. A criação ocorreu por meio de um processo iterativo de engenharia de \textit{prompt}, no qual diversas instruções foram testadas e progressivamente refinadas para convergir na representação visual desejada. Dentre os critérios e restrições solicitados à ferramenta nas sucessivas rodadas, destacaram-se:
