...
A seleção de cores foi fundamentada nos estudos da psicologia das cores aplicados ao design digital (HELLER, 2002), buscando transmitir tranquilidade e afeto sem perder o destaque necessário para avisos de alerta. A Figura~\ref{fig:paleta_cores} apresenta a paleta cromática oficial do WeFIND, organizada em três categorias: cores da marca, tipos de publicação e cores de interface.
