...
Visando mapear o estado da arte e identificar deficiências a serem superadas no projeto do WeFIND, realizou-se uma análise comparativa orientada aos critérios de usabilidade e experiência do usuário preconizados por Amstel (2024). Foram analisadas as três principais plataformas de referência no segmento: \textit{Viu Meu Pet}, \textit{PawBoost} e \textit{AlertPet}.
