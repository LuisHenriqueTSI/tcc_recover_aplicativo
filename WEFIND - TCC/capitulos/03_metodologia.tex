...
\paragraph{Viu Meu Pet:} Trata-se de uma das plataformas brasileiras mais difundidas na área, oferecendo portal web e aplicativo móvel (Figura~\ref{fig:viumeupet}). 
...
\paragraph{Pet911:} Plataforma de abrangência internacional com versão dedicada ao público brasileiro, focada na centralização de anúncios de achados e perdidos de animais domésticos (Figura~\ref{fig:pet911}).
