...
Conforme evidenciado no gráfico da Figura~\ref{fig:uso_coleira}, 70\% dos entrevistados (14 respostas) indicaram que seus animais domésticos não utilizam nenhum tipo de coleira no dia a dia. Entre a minoria que adota algum cuidado, 25\% (5 respostas) utilizam plaquinha de metal comum com gravação manual e somente 5\% (1 resposta) contam com coleiras equipadas com rastreamento eletrônico por GPS. A constatação de que sete em cada dez animais circulam sem qualquer identificação imediata reforça a necessidade de soluções de identificação preventiva e de baixo custo, como o cadastro de animais tutelados com código QR proposto no WeFIND.
...
Os resultados da Figura~\ref{fig:pesquisa_meios} demonstram uma dependência concentrada nas redes sociais genéricas (55\%, 11 respostas) e nos grupos de troca de mensagens do WhatsApp (25\%, 5 respostas). Em contrapartida, os cartazes impressos colados em postes somaram apenas 10\% das escolhas, enquanto o aviso direto a vizinhos e em clínicas veterinárias representaram 5\% cada.

Apesar da preferência pelas redes sociais, os participantes relataram obstáculos severos: as publicações em feeds de redes sociais perdem visibilidade rapidamente devido ao grande volume de novas postagens diárias, não há filtros por proximidade no mapa e os números de telefone particulares ficam expostos a golpes e trotes. Para avaliar a viabilidade de uma alternativa focada na localização imediata, consultou-se o nível de interesse dos participantes na utilização de uma aplicação móvel com mapa georreferenciado e filtros de raio de busca (Figura~\ref{fig:interesse_mapa}).
