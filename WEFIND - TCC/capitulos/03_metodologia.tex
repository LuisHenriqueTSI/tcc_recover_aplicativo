...
Os dados da Figura~\ref{fig:adocao_microchip} revelam que a expressiva maioria dos animais (70\%, totalizando 14 respostas) não possui microchip de identificação eletrônica, somando-se a 5\% (1 resposta) de participantes que declararam não saber responder. Apenas 25\% dos respondentes (5 participantes) afirmaram que seus animais possuem o dispositivo. Esse índice evidencia que, embora o microchip seja o padrão internacional mais seguro para comprovação de tutela, sua adesão permanece restrita no contexto brasileiro, seja em virtude dos custos veterinários para implantação, seja pela indisponibilidade de leitores universais na rotina da população em geral.
...
A síntese entre o levantamento empírico de campo e a análise comparativa de plataformas similares consolidou o conjunto basilar de necessidades sociais e técnicas que orientou a concepção de todo o ecossistema WeFIND: a urgência de uma barreira preventiva de identificação rápida e gratuita (carteirinha digital com código QR para coleiras, suprindo o déficit de coleiras e microchips verificado em 70\% dos animais), a centralidade do mapa interativo georreferenciado com filtros de proximidade (reivindicado por 95\% dos participantes), a automação na confecção de cartazes padronizados de busca e a exigência mandatória de um canal de bate-papo privativo em tempo real para blindar o número telefônico pessoal dos cidadãos contra golpes. A articulação estrita e contínua entre essas carências diagnosticadas, os requisitos de software formulados, as telas desenvolvidas e os procedimentos de teste executados encontra-se estruturada na Matriz de Rastreabilidade de Requisitos e Testes, apresentada no Apêndice D deste trabalho.
