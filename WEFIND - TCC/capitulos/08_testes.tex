...
\textbf{CT25} & RF46 & Processamento do Algoritmo de Matching Multicritério & Cadastrar publicação de animal encontrado com atributos e localização compatíveis com animal perdido prévio (teste positivo) e com atributos opostos (teste negativo com espécies e sexos distintos) & Descarte imediato (0\% de semelhança) para casos com deal breakers; cálculo correto do percentual ponderado ($\ge 85\%$) para casos compatíveis; exibição no mural de correspondências e disparo automático de alertas bidirecionais via notificação e WhatsApp & \statusTeste \\ \hline
\end{longtable}
}
