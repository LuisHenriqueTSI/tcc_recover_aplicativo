...
Para apresentar a ligação entre os requisitos levantados e os casos de uso do sistema, o Quadro~\ref{quadro:mapeamento_rf_uc} traz a tabela de rastreabilidade entre os 43 requisitos funcionais e os casos de uso correspondentes, indicando o ator principal e o tipo de relação em cada situação.
