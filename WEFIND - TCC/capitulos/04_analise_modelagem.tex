...
Para a busca de animais, o aplicativo oferece os casos de uso \textit{Visualizar Publicações}, em formato de lista no mural, e \textit{Visualizar Animais no Mapa}, que posiciona os animais diretamente sobre o mapa da região. Na listagem de publicações, o usuário conta com as extensões (\textit{«extend»}) \textit{Utilizar Filtro Avançado}, para filtragem multicritério de espécies e características, \textit{Ajustar Raio de Proximidade}, para definir a distância máxima da busca, e \textit{Atualizar Localização}, para atualizar sua posição via GPS.
