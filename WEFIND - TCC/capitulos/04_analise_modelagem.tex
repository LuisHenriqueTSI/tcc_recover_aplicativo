...
Para facilitar o entendimento, os casos de uso do sistema proposto foram organizados em dois diagramas: o primeiro voltado ao usuário visitante, que navega pelo aplicativo antes de realizar a autenticação; e o segundo apresentando todas as funções do usuário autenticado e as ferramentas de moderação do administrador.
