...
\begin{figure}[H]
    ...
    \includegraphics[width=0.88\textwidth]{imagens/02_modelagem/figura08_diagrama_classes.pdf}
    \fonte{Autoria própria (2026)}
\end{figure}
...
Com os requisitos funcionais e não funcionais estabelecidos e os modelos conceituais da UML devidamente formalizados, o Capítulo 5 apresenta a plataforma WeFIND, detalhando sua proposta de valor comunitária, o relato de motivação do autor e a justificativa técnica para a priorização da abordagem móvel em detrimento de uma solução web tradicional.
